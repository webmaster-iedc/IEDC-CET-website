    ...
    return(
        ...
        <div className="w-full flex text-center flex-col lg:w-3/4">
          ...
          <div className="md:w-1/2 w-3/4 flex flex-col self-center">
            ...
            <a href="/#InnovateX" target="" className="w-100 h-30 px-7 py-2 mt-8 rounded-lg bg-[#9E130A] text-poppins text-24 font-semibold leading-36 text-white text-center" onClick={() => scrollToSection(item.sectionRef)}>REGISTER</a>
