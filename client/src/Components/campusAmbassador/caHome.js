...
function caHome(){
    return(
        ...
        <div className="text-white w-3/4 flex self-center text-center flex-col lg:w-3/4">
          <h className="font-semibold text-center lg:text-7xl md:text-6xl text-3xl tracking-widest bg-gradient-to-b from-[#FA1100] to-[#5E5D5D] bg-clip-text text-transparent">
