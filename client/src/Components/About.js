...
function About() {
  ...
  return (
    <div className="text-left flex flex-col gap-10 space-y-4 w-3/4 self-center text-white text-4xl mx-5 font-bold">
      <h className="block text-center">IEDC at CET</h>
