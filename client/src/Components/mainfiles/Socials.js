    ...
    return (
        <div className='pb-3'>
            <ul className='flex text-[#5658DD]'>
                <li className='px-2'>
                    <a className="p-2 flex" target="_blank" href="https://www.facebook.com/iedccet/" rel="noopener noreferrer">
                ...
                <li className='px-2'>
                    <a className="p-2 flex" target="_blank" href="https://mobile.twitter.com/iedccet" rel="noopener noreferrer">
                        <FaTwitter size={20} className='hover:text-[#ACADFF] cursor-pointer mx-auto' />
                    </a>
                </li>
                <li className='px-2'>
                    <a className="p-2 flex" target="_blank" href="https://www.instagram.com/iedc_cet/?hl=en" rel="noopener noreferrer">
